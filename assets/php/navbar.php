...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="assets/img/images.png" class="rounded-circle w-25" alt="book"></a>
    ...
    <button class="btn btn-outline-success" type="submit">Search</button>
      ...
      <?php
        if($_SESSION['login'] === 'true') {
          ?>
          <a href="profilo.php"><img src="<?= $_SESSION['user_image'] ?>" style="width: 30px; height: 30px;border-radius: 50%; cursor: pointer;" class="mx-3" alt="img"> </a>
